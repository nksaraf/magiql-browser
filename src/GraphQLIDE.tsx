      ...
      <div className={bw`px-1 py-1`}>
        <div
          ...
          className={bw`px-2 rounded-full ${{
            "text-blueGray-500": tabs.length >= tabBreakpoints[0],
            "text-blueGray-300": tabs.length < tabBreakpoints[0],
          }}
          sm:(${{
            "text-blueGray-500": tabs.length >= tabBreakpoints[1],
            "text-blueGray-300": tabs.length < tabBreakpoints[1],
          }}) md:(${{
            "text-blueGray-500": tabs.length >= tabBreakpoints[2],
            "text-blueGray-300": tabs.length < tabBreakpoints[2],
          }}) lg:(${{
            "text-blueGray-500": tabs.length >= tabBreakpoints[3],
            "text-blueGray-300": tabs.length < tabBreakpoints[3],
